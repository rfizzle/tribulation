...
- The Heart Fragment and Shatter Shard no longer render clipped at the edge of their icon — every item sprite now keeps a clean margin inside its canvas and sits centred in the slot.
